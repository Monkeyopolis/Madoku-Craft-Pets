...
public final class PetRendererManager {
	...
	private static final class MadokuPetRenderer extends EntityRenderer<MadokuPetEntity, PetRenderState> {
		private static final Identifier BAT_TEXTURE = texture("textures/entity/bat.png");
		private static final Identifier BEE_TEXTURE = texture("textures/entity/bee/bee.png");
		private static final Identifier CHICKEN_TEXTURE = texture("textures/entity/chicken/temperate_chicken.png");
		private static final Identifier COW_TEXTURE = texture("textures/entity/cow/temperate_cow.png");
		private static final Identifier CREEPER_TEXTURE = texture("textures/entity/creeper/creeper.png");
		private static final Identifier PIG_TEXTURE = texture("textures/entity/pig/temperate_pig.png");
		...
		MadokuPetRenderer(EntityRendererProvider.Context context) {
			...
			this.profiles = Map.of(
				...
				"minecraft:bee", new BeeProfile(new BeeModel(context.bakeLayer(ModelLayers.BEE)), BEE_TEXTURE),
				"minecraft:chicken", new ChickenProfile(new ChickenModel(context.bakeLayer(ModelLayers.CHICKEN)), CHICKEN_TEXTURE),
	...
	private static final class LivingProfile implements PetModelProfile {
		...
		public void render(PetRenderState source, PoseStack poseStack, SubmitNodeCollector collector) {
			...
			collector.submitModel(model, source, poseStack, RenderTypes.entityCutoutNoCull(texture), source.lightCoords, OverlayTexture.NO_OVERLAY, source.outlineColor, null);
		}
	}
	...
	private static final class BatProfile implements PetModelProfile {
		...
		public void render(PetRenderState source, PoseStack poseStack, SubmitNodeCollector collector) {
			...
			collector.submitModel(model, state, poseStack, RenderTypes.entityCutoutNoCull(texture), source.lightCoords, OverlayTexture.NO_OVERLAY, source.outlineColor, null);
		}
	}
	...
	private static final class BeeProfile implements PetModelProfile {
		...
		private BeeProfile(BeeModel model, Identifier texture) {
			this.model = model;
			this.texture = texture;
		}
	...
	private static final class ChickenProfile implements PetModelProfile {
		...
		private ChickenProfile(ChickenModel model, Identifier texture) {
			this.model = model;
			this.texture = texture;
		}
	...
	private static final class SheepProfile implements PetModelProfile {
		...
		public void render(PetRenderState source, PoseStack poseStack, SubmitNodeCollector collector) {
			...
			collector.submitModel(woolModel, state, poseStack, RenderTypes.entityCutoutNoCull(MadokuPetRenderer.texture("textures/entity/sheep/sheep_wool.png")), source.lightCoords, OverlayTexture.NO_OVERLAY, source.outlineColor, null);
		}
	}
